...
dict_AC = {'NULL': 0, "NoLimit": 1, "OwnerLimit": 2}
...
dict_NodeOpName = {"NULL": 0, "Normal": 1, "Core": 2, "CoreCall": 3}
...
if __name__ == "__main__":
    node = "../../reentrancy/graph_data/nodes/3.sol"
    edge = "../../reentrancy/graph_data/edges/3.sol"
    ...
    v_path = "../../reentrancy/graph_data/nodes/"
    e_path = "../../reentrancy/graph_data/edges/"
    ...
    contract_name = open("../../reentrancy/final_reentrancy_name.txt")  # contracts list
    contract_label = open("../../reentrancy/final_reentrancy_label.txt")  # contracts label
